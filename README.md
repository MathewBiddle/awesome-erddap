...
- [ERDDAP Gold Standard](https://github.com/ioos/erddap-gold-standard) - Example datasets and configuration for ERDDAP for the IOOS community.
- [IOOS ERDDAP quick start](https://ioos.github.io/erddap-gold-standard/index.html) - A quick start guide for standing up an ERDDAP server using Docker.
